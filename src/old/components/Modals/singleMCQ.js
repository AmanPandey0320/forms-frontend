...
const SingleMCQModal = (props) => {
    ...
    return ( 
        <Modal show={props.smModalView} onHide={()=>{props.setSmModalView(false)}}>
            <Modal.Header>

                <Modal.Title>
                    <IconContext.Provider value={{size:'1.5em',color:formThemes[props.theme].body}}>
                        <ImRadioChecked/>&nbsp;Single-correct MCQ
            ...
            <Modal.Footer>
                    <ThemeProvider theme={MuiThemes[props.theme]}>
                        <Button variant='contained' onClick={()=>{props.setSmModalView(false)}} color="secondary">Cancle</Button>
